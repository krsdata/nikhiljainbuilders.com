		...
		<div class="row">
			<div class="col-md-3 col-sm-3 col-ms-6 col-xs-12">
				<div class="f_top_inner">
					<a href="<?php echo esc_url($hotel_galaxy_settings['footer_collout_link_1']); ?>"><h4><?php echo esc_html($hotel_galaxy_settings['footer_collout_title_1']); ?></h4></a>
					<span class="icon"><i class="<?php echo esc_attr($hotel_galaxy_settings['footer_collout_icon_1']); ?>"></i></span> 
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-ms-6 col-xs-12">
				<div class="f_top_inner">
					<a href="<?php echo esc_url($hotel_galaxy_settings['footer_collout_link_2']); ?>"><h4><?php echo esc_html($hotel_galaxy_settings['footer_collout_title_2']); ?></h4></a>
					<span class="icon"><i class="<?php echo esc_attr($hotel_galaxy_settings['footer_collout_icon_2']); ?>"></i></span> 
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-ms-6 col-xs-12">
				<div class="f_top_inner">
					<a href="<?php echo esc_url($hotel_galaxy_settings['footer_collout_link_3']); ?>"><h4><?php echo esc_html($hotel_galaxy_settings['footer_collout_title_3']); ?></h4></a>
					<span class="icon"><i class="<?php echo esc_attr($hotel_galaxy_settings['footer_collout_icon_3']); ?>"></i></span>  
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-ms-6 col-xs-12">
				<div class="f_top_inner r_border">
					<a href="<?php echo esc_url($hotel_galaxy_settings['footer_collout_link_4']); ?>"><h4><?php echo esc_html($hotel_galaxy_settings['footer_collout_title_4']); ?></h4></a>
					<span class="icon"><i class="<?php echo esc_attr($hotel_galaxy_settings['footer_collout_icon_4']); ?>"></i></span>  
				</div>
			</div>
		</div>
	</div>
